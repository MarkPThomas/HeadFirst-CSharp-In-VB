...
Public Class DinnerParty
    Public Const CostOfFoodPerPerson As Decimal = 25
    ...
    Public ReadOnly Property Cost As Decimal
        Get
            ...
            If HealthyOption Then totalCost *= 0.95D
    ...
    Public Function CalculateCostOfDecorations() As Decimal
    ...
    Public Function CalculateCostOfBeveragesPerPerson() As Decimal
