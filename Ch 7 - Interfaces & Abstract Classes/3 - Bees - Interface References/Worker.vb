...
Public Class Worker
    ...
    Private Const honeyUnitsPerShiftWorked As Double = 0.65
    ...
    Public Overrides Function HoneyConsumptionRate() As Double
        Dim myHoneyConsumptionRate As Double = MyBase.HoneyConsumptionRate()
        myHoneyConsumptionRate += honeyUnitsPerShiftWorked * shiftsWorked

        Return myHoneyConsumptionRate
    End Function
End Class
