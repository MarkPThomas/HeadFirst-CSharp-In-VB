...
Module Module1
    ...
    Sub Main()
        ...
        Dim comparer As New CardComparer_byValue()
        ...
        For i = 0 To numberOfRandomCards - 1
            ...
            Dim card As New Card(CType(numberBetween0And3, Suits),
                                 CType(numberBetween1And13, Values))
        ...
        cards.Sort(comparer)
        Console.WriteLine(vbCrLf & "The same " & numberOfRandomCards & " cards, sorted: ")
        For Each cardItem As Card In cards
            Console.WriteLine(cardItem.Name)
        Next
