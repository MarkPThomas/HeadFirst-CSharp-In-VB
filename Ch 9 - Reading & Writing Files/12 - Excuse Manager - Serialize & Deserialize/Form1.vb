...
Public Class Form1
    ...
    Private Const STRING_FILTER As String = "Text Files (*" & Excuse.EXCUSE_FILE_EXTENSION & ")|*" & Excuse.EXCUSE_FILE_EXTENSION & "|All Files (*.*)|*.*"
    ...
    Private Function FileName() As String
        Return currentExcuse.Description & Excuse.EXCUSE_FILE_EXTENSION
    End Function
    ...
    Private Sub FormEditingStarted()
    ...
    Private Sub results_KeyDown(sender As Object, e As KeyEventArgs) Handles results.KeyDown
        FormEditingStarted()
    End Sub

    Private Sub lastUsed_KeyDown(sender As Object, e As KeyEventArgs) Handles lastUsed.KeyDown
        FormEditingStarted()
    End Sub

    Private Sub lastUsed_MouseDown(sender As Object, e As MouseEventArgs) Handles lastUsed.MouseDown
        FormEditingStarted()
    End Sub
End Class
